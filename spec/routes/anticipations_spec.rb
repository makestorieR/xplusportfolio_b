...
#     it "DELETE api/v1/anticipations/todo-application routes to api/v1/anticipations#destroy" do
#         expect(delete '/api/v1/anticipations/todo-application').to route_to(controller: 'api/v1/anticipations', action: 'destroy', id: 'todo-application')  
#     end
